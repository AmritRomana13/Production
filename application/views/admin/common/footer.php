...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <!-- Settings -->
        <hr class="mt-0" />
        <h6 class="text-center mb-0">Choose Color Mode</h6>

        <div class="p-4">
            <div class="mb-2">
                <img src="<?php echo base_url('admin_assets/') ?>images/layouts/layout-1.jpg" class="img-thumbnail" alt="layout images">
            </div>
            ...
            <div class="mb-2">
                <img src="<?php echo base_url('admin_assets/') ?>images/layouts/layout-2.jpg" class="img-thumbnail" alt="layout images">
            </div>
            <div class="form-check form-switch mb-3">
